...
const grid = Array(cellsVertical).fill(null)   //ROWS
    .map(() => Array(cellsHorizontal).fill(false));    //COLUMNS

// vertical and horizontal array will check whether the wall is open or not
const verticals = Array(cellsVertical).fill(null)    //ROWS
    .map(() => Array(cellsHorizontal-1).fill(false));   //COLUMNS

const horizontals = Array(cellsVertical-1).fill(null)  //ROWS
    .map(() => Array(cellsHorizontal).fill(false));   //COLUMNS
